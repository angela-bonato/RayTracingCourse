...
proc test_write_pfm() : void =
    ...
    img_w.setPixel(0, 0, col1) 
    img_w.setPixel(1, 0, col2) 
    img_w.setPixel(2, 0, col3) 
    img_w.setPixel(0, 1, col4) 
    img_w.setPixel(1, 1, col5)
    img_w.setPixel(2, 1, col6)
    ...
    assert img_w.width == img_r.width
    assert img_w.height == img_r.height
    assert img_w.pixels == img_r.pixels
